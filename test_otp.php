...
$request = Request::create('/api/v1/auth/otp/send-email', 'POST', [], [], [], [], json_encode(['email' => 'delivered@resend.dev']));
...
$request2 = Request::create('/api/v1/auth/otp/send', 'POST', [], [], [], [], json_encode(['email' => 'delivered@resend.dev']));
...
$cachedOtp = Illuminate\Support\Facades\Cache::get('otp_delivered@resend.dev');
echo "Cached OTP generated for delivered@resend.dev: " . ($cachedOtp ?: 'None') . "\n\n";

echo "--- 3. Testing /api/v1/auth/otp/verify with correct OTP ---\n";
$request3 = Request::create('/api/v1/auth/otp/verify', 'POST', [], [], [], [], json_encode([
    'identifier' => 'delivered@resend.dev',
    'otp' => $cachedOtp,
    'type' => 'email'
]));
